...
private:
    ...
    /// Queued WorkerEvent can run nested (DonePopulating calls processEvents). Only reset the worker
    /// when the outermost WorkerEvent unwinds.
    int m_worker_event_depth = 0;
